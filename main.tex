...
%document
\title{How do we reliably measure misinformation online?}
\author{Luehring, J., Lazzaroni, R.M., Lasser, J.}
\date{September 2023}
...
The ramifications of misinformation are multifaceted and may range from political polarization (Guess et al., 2023) to vaccine hesitancy (Brennen et al., 2023). Consequently, it is imperative to understand the spread of misinformation and its interactions with digital media and society. In order to do so, computational social scientists need to have access to reliable and valid data. By reviewing strategies to research misinformation online, and assessing the reliability of source-based approaches in particular, we outline potential drawbacks and pitfalls for digital media research and offer recommendations for the application of the NewsGuard database in different contexts.
