...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{figures/f1-sources_over_time_bimonthly.png}
...
In the latest version of the dataset, the criterion ``Avoids deceptive headlines'' was the most respected, and 8,754 of the sources satisfied it (79 \% of sources). Across all dataset versions, the most common combination of values is that all criteria are satisfied (XY\% of sources), given that most sources are considered trustworthy. The second most common combination is that all criteria are satisfied except for the criterion ``Does not repeatedly publish false content'' (XY\% of sources).
