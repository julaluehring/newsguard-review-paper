...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{f1-sources_over_time_bimonthly.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{f2-trustworthiness_distribution.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{f4-scores_over_time.png}
    \caption{Distribution of trustworthiness scores over time}
    \label{fig:fig3}
\end{figure}

NewsGuard regularly adds new sources to the database but rarely removes any, i.e., the database has been growing. Zooming in on the type of sources removed from the database, they overall tend to have a lower trustworthiness score than added sources. Over time, the  is likely due to the fact that the organization has been adding untrustworthy domains, while trustworthy domains 
A great number of sources with lower ratings (M=46.5, SD=31.62) were added in 2020, which might explain the lower average trustworthiness score in the following. In contrast, scores of already covered sources tend to decrease over time, i.e., when NewsGuard updates trustworthiness ratings, they tend to get a lower score. This is shown in Figure XY. %how relevant is this point?
