...
Over the span of four years, NewsGuard has grown from 2,641 to 9,734 domains, as shown in Figure 2 ~\ref{fig:fig2}. The selection and removal of domains is unclear. Still, the organization claims to have reviewed domains accounting for 95\% of online engagement.
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{sources_over_time_midmonth.png}
    \caption{Number of domains over time}
    \label{fig:fig2}
\end{figure}
