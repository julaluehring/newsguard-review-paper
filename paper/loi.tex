...
A prominent domain list is curated by the organization NewsGuard \citep{robertsonUsersChooseEngage2023a,lasserSocialMediaSharing2022a}, however, it is proprietary and so far only validated for the U.S. context by \cite{linHighLevelCorrespondence2023}. 
