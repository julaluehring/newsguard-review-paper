...
NewsGuard applies an expert-based approach; analysts assign and regularly update overall reliability ratings (0 to 100) based on nine binary criteria (see \href{https://www.newsguardtech.com/ratings/rating-process-criteria/}{here}). For the U.S. context, the list has shown high agreement with other expert-rated lists \citep{linHighLevelCorrespondence2023}, but it is crucial to assess the usefulness for research beyond the English-speaking world. Moreover, the ratings were initially created as a tool for brand security rather than a research instrument, which is why the list is propriatory and access as well as publication of the data is restricted. %Second, ratings and sources are updated in unknown intervals, which is why it is important to understand the update process of the ratings as well as changes in source coverage. 
